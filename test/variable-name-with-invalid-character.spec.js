  ...
  valid: [
    ...
    invalid: [
      ...
      },
      {
        ...
        `)),
        report: [
          { id: 'Task_Error', message: "Output variable name 'var=1' must not contain an invalid character (+,-,*,/,=,>,?,.)." },
          { id: 'Timer_Error', message: "Output variable name 'var?invalid' must not contain an invalid character (+,-,*,/,=,>,?,.)." }
        ]
      },
      {
