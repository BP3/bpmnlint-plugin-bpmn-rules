  ...
  valid: [
    {
      ...
      moddleElement: createModdle(
        generateFragment('<bpmn:escalation id="Escalation_0eb1rq6" name="EscalationToManager" />')
      ),
    },
  ],
  invalid: [
    {
      ...
      moddleElement: createModdle(
        generateFragment('<bpmn:escalation id="Escalation_0eb1rq6" name="Escalation_0eb1rq6" />')
      ),
      report: [
        {
